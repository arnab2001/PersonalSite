...
import thumbCodecompass from "../public/images/codecompass.png";
import thumbSocialite from "../public/images/socialite.png";
...
const Works = () => (
    ...
    <Layout title = "works">
        <Container>
            ...
            <Section delay={0.1}>
                <WorkGridItem id="codecompass" title="Codecompass.ai" thumbnail={thumbCodecompass} borderRadius='md'>
                    An AI-powered tool enabling developers to have conversations with their codebase, featuring instant contextual QnA and real-time code updates using OpenAI, Pinecone, and LangChainJS.
                </WorkGridItem>
            </Section>

            <Section delay={0.3}>
                <WorkGridItem id="socialite" title="Socialite" thumbnail={thumbSocialite} borderRadius='md'>
                    A social media webapp with features like JWT authentication, post creation with file uploads, post interactions, friend system, and real-time notifications using Socket.io.
                </WorkGridItem>
            </Section>
